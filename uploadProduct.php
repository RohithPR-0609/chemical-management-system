...
<head></head>
      <?php
                        ...
                        if ($bool) {
                        mysqli_query($connection, "insert into chemical(chid,chname,chcost,chavilability,chduedate,chstate)
						values ('$chid','$chname','$chcost','$chavilability','$chduedate','$chstate')");
                        Print '<script>alert("Successfully Added!");</script>';
                        Print '<script>window.location.assign("uploadProduct.php");</script>';
                        }
                        }
    ...
    <div class="form-area">  
        ...
        <br style="clear:both">
    				...
    				<div class="form-group">
						<input type="text" class="form-control" id="name" name="chid" placeholder="Chemical Id" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="email" name="chname" placeholder="Chemical Name" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="mobile" name="chcost" placeholder="Price" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="subject" name="chavilability" placeholder="Quantity" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="subject" name="chduedate" placeholder="Expire date" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="subject" name="chstate" placeholder="Chmeical state" required>
					</div>
