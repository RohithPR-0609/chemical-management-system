				...
				<div class="container">
					...
					<div class="row nav-menu">
						...
						<div class="col-sm-12 columns text-center">
							<ul class="menu">
								<a></a><li><a href="index.php"target="_self">login</a></li><li><a href="admin.php"target="_self">admin<li><a href="category.php" target="_self">categories</a></li><li><a href="locations.php" target="_self">centres</a></li><li>
				...
				<div class="container align-vertical">
					<div class="row">
						<div class="col-md-7 col-sm-8">
							...
							<h1 class="text-white">CHEMICAL STORE</h1>
							<p class="lead text-white">LEAVE LIVE AND BUY ONLINE .</p>
